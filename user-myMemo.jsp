...
<div class="py-5" id="elements">
  <div class="container">
    <div class="book-entry mb-4">
      <div class="row g-0">
        <div class="col-md-2">
          <a href="/book1-detail-page">
            <img src="../img/책표지.png" alt="책 표지" class="img-fluid book-cover">
          </a>
        </div>
        <div class="col-md-10">
          <div class="card-body">
            <a href="/book1-detail-page" class="book-title-link">
              <h3 class="book-title">떠나, 돈 공부 절대 미루지 마라</h3>
            </a>
            <form action="/author-search" method="post" class="d-inline">
              <input type="hidden" name="author" value="이즈미 마사토">
              <button type="submit" class="btn btn-link p-0 book-author">이즈미 마사토</button>
            </form>
            <div class="book-memo">
              <p>메모를 입력하세요...</p>
            </div>
    ...
    <div class="book-entry mb-4">
      <div class="row g-0">
        <div class="col-md-2">
          <a href="/book2-detail-page">
            <img src="../img/책표지.png" alt="책 표지" class="img-fluid book-cover">
          </a>
        </div>
        <div class="col-md-10">
          <div class="card-body">
            <a href="/book2-detail-page" class="book-title-link">
              <h3 class="book-title">싸우는 심리학 - 한국 사회를 읽는</h3>
            </a>
            <form action="/author-search" method="post" class="d-inline">
              <input type="hidden" name="author" value="싸운다">
              <button type="submit" class="btn btn-link p-0 book-author">싸운다</button>
            </form>
            <div class="book-memo">
              <p>메모를 입력하세요...</p>
            </div>
