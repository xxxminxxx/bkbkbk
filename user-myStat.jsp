			...
			<div class="row g-5">
				<div class="col-lg-6">
					...
					<div class="progress mt-3" role="progressbar" aria-label="기본 예" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
							${vo.bookMonth}월 &nbsp;
													<div class="progress-bar" style="width: ${vo.bookCount}%;">
															${vo.bookCount}권
													</div>
					</div>
					</c:forEach>--%>
				...
				<div class="col-lg-6">
					...
					<%--<c:forEach items="${userStatVO}" var="vo">
						<div class="progress mb-2" role="progressbar" aria-label="성공 사례" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
							${vo.titleLengthStr}
							<div class="progress-bar bg-success" style="width: ${vo.percent}%;"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
									${vo.percent}%
						</font></font></div>
					</div>
					</c:forEach>--%>
