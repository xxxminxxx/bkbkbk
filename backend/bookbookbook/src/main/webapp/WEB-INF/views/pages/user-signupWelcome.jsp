...
<body>
    ...
    <div class="cover-slide" id="welcome-cover">
		<script src="https://unpkg.com/@dotlottie/player-component@latest/dist/dotlottie-player.mjs" type="module"></script> 
		    ...
		    <dotlottie-player src="https://lottie.host/b6b5ddc7-d523-4905-a335-332010ed32dd/mTbOGcv6x2.json" background="transparent" speed="1" style="width: 1200px; height: 1200px;" loop autoplay></dotlottie-player>
    </div>
