		...
		<script>
					                ...
					                '<div class="d-flex align-items-center gap-3 osahan-mb-1">' +
					                    ...
					                    '<div class="lh-sm">' +
											(parsedMessage.senderId === userId?
											        '<h6 class="fw-bold text-success mb-2" style="font-size:20px">' + parsedMessage.sender + '</h6>' :
											        '<h6 class="fw-bold text-primary mb-2" style="font-size:20px">' + parsedMessage.sender + '</h6>'
											    ) +
					                        '<h6 class="text-truncate mb-2 bold" style="font-size:20px">' + parsedMessage.content + '</h6>' +
					                        '<small class="text-muted" style="font-size:15px">' + localizedDate + '</small>' +
					                    '</div>' +
					                '</div>' +
					            '</div>' +
								(parsedMessage.senderId === userId?
								        '<div class="ms-auto d-flex align-items-center gap-3 text-center small"></div>':
			  ...
			  $(document).on('submit', 'form[name="reportForm"]', function(e) {
			   ...
			   $('#exit').click(function(e) {
			                   ...
			                   Swal.fire({
			                       title: '채팅방을 나가시겠습니까?',
			                       text: '채팅방에 남은 인원이 0명이 될 경우 방은 자동으로 삭제됩니다.',
			                       icon: 'warning',
			                       showCancelButton: true,
			                       confirmButtonText: '예, 나가겠습니다.',
			                     confirmButtonColor:'#F14F00',
