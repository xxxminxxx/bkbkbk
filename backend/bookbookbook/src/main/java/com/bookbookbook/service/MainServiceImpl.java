...
public class MainServiceImpl implements MainService {
    ...
    public void deleteChatroom(String roomNum) {
       ...
       mainDAO.deleteChatroom(roomNum);
		...
		public Map<String, Object> getBookByBookNum(Integer bookNum) {
			System.out.println("MainService 호출 getBookByBookNum : " + bookNum);
			Map<String, Object> result = mainDAO.getBookByBookNum(bookNum);
			System.out.println("getBookByBookNum 반환값 : " + result);
			return result;
		}
