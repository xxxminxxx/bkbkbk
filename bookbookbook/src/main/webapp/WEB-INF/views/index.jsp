        ...
        <div class="container py-5">
            <div class="row align-items-center g-4 py-5">
                ...
                <div class="news-section mt-5">
                    ...
                    <div class="news-item">
                        <img src="image-url-news-1" alt="News 1">
                        <div class="news-content">
                            <h5>뉴스 제목 1</h5>
                            <p>뉴스 설명 1입니다. 이곳에 뉴스의 간략한 내용을 적습니다.</p>
                        </div>
                    </div>
                    <div class="news-item">
                        <img src="image-url-news-2" alt="News 2">
                        <div class="news-content">
                            <h5>뉴스 제목 2</h5>
                            <p>뉴스 설명 2입니다. 이곳에 뉴스의 간략한 내용을 적습니다.</p>
                        </div>
                    </div>
                    <div class="news-item">
                        <img src="image-url-news-3" alt="News 3">
                        <div class="news-content">
                            <h5>뉴스 제목 3</h5>
                            <p>뉴스 설명 3입니다. 이곳에 뉴스의 간략한 내용을 적습니다.</p>
                        </div>
                    </div>
                </div>
            </div>
