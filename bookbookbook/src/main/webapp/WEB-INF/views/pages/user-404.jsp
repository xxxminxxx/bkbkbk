                    ...
                    <div class="row justify-content-center align-items-center">
                        ...
                        <div class="col-md-6">
                            <div class="mb-6 mb-lg-0 py-4">
                                ...
                                <h1 class="mb-3 fw-bolder mt-2 display-4">해당 페이지를 찾지 못했습니다.</h1>
                                ...
                                <!-- btn -->
                                <a href="index.jsp" class="btn btn-outline-purple btn-theme ms-2">메인페이지로 이동</a>
                            </div>
                        </div>
                        <div class="col-md-6">
							<script src="https://unpkg.com/@dotlottie/player-component@latest/dist/dotlottie-player.mjs" type="module"></script> 

							    <dotlottie-player src="https://lottie.host/7fecb60e-9880-4fc8-9ccc-183e185e5225/ZihNGbyqn9.json" 
